...
def collect_speakers_files(audios_dir, audioTemplate="*-norm.wav"):
    result = []
...
class MixtureGenerator:
    ...
    def triplet_generator(self, target_speaker, noise_speaker, number_of_triplets):
        """
        Generates min(number_of_triplets, max(#target_audios, #noise_audios)) triplets
        for given target and noise speakers
        """
